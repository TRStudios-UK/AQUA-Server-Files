...
-- RegisterNetEvent("CXRP:sendGangFunds")
-- AddEventHandler("CXRP:sendGangFunds",function(funds)
--     gangfunds = funds
-- end)


-- RMenu.Add('vRPGangFunds', 'main', RageUI.CreateMenu("Gang Funds", "~b~Gang Funds", GetRageUIMenuWidth(),GetRageUIMenuHeight())
...
--                     TriggerServerEvent('CXRP:getGangFunds')
