...
AddEventHandler("playerSpawned",function()
    local h = true
    if h then 
        TriggerServerEvent("CXRP:GetGangData")
    end 
end)
RegisterNetEvent("CXRP:GotGangData")
AddEventHandler("CXRP:GotGangData",function(i,j,k,PO)
    if i==nil then 
        PlayerIsInGang=false 
    else 
        PlayerIsInGang=true
...
RegisterNetEvent("CXRP:disbandedGang")
AddEventHandler("CXRP:disbandedGang",function()
    showGangUI=false
    showNoGangUI=true
    PlayerIsInGang=false
    ...
    TriggerEvent("CXRP:ForceRefreshData")
end)
RegisterNetEvent("CXRP:ForceRefreshData")
AddEventHandler("CXRP:ForceRefreshData",function()
    TriggerServerEvent("CXRP:GetGangData")
end)
RegisterNetEvent("CXRP:InviteRecieved")
AddEventHandler("CXRP:InviteRecieved",function(o,Q)
    CXRPGangInvites[CXRPGangInviteIndex]=Q
    CXRPGangInviteIndex=CXRPGangInviteIndex+1
    Notify(o)
end)
RegisterNetEvent("CXRP:gangNameNotTaken")
AddEventHandler("CXRP:gangNameNotTaken",function()
    showNoGangUI=false
    showGangUI=true
    PlayerIsInGang=true 
end)
function func_drawGangUI()
    if showNoGangUI then 
        ...
        DrawAdvancedText(0.558,0.303,0.005,0.0028,0.539,"Aqua Gangs",255,255,255,255,7,0)
        ...
        for p,q in pairs(CXRPGangInvites)do 
        ...
        if CursorInArea(0.35,0.415,0.415,0.46)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if createGangName~=nil and createGangName~="null"and createGangName~=""then 
                    TriggerServerEvent("CXRP:CreateGang",createGangName)
                else 
        ...
        if CursorInArea(0.435,0.51,0.415,0.46)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedGangInvite~=nil then 
                    selectedGangInvite=CXRPGangInvites[selectedGangInvite]
                    local perm1s = getUserId()
                    TriggerServerEvent("CXRP:addUserToGang",selectedGangInvite,perm1s)
                    CXRPGangInvites={}
                    showNoGangUI=false
                    CXRPGangInviteIndex=0
                    showGangUI=true
    ...
    if showFundsGangUI then 
        ...
        DrawAdvancedText(0.591,0.378,0.005,0.0028,0.48,"Aqua gang - funds",255,255,255,255,7,0)
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if amount~=nil then 
                    if closeToLegion()then 
                        TriggerServerEvent("CXRP:depositGangBalance",amount)
                    end 
                else 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if amount~=nil then 
                    if gangPermission>=3 then 
                        if closeToLegion()then 
                            TriggerServerEvent("CXRP:withdrawGangBalance",amount)
                        end 
                    else 
    ...
    if showMembersGangUI then 
        ...
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"Aqua gang - members",255,255,255,255,7,0)
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedMember~=nil and PlayerIsInGang and gangID~=nil then 
                    if gangPermission>=4 then 
                        TriggerServerEvent("CXRP:PromoteUser",gangID,tonumber(selectedMember))
                    else 
        ...
        if CursorInArea(0.6182,0.6822,0.4138,0.4694)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if selectedMember~=nil and PlayerIsInGang and gangID~=nil then 
                    if gangPermission>=4 then 
                        TriggerServerEvent("CXRP:DemoteUser",gangID,selectedMember)
                    else 
                ...
                if selectedMember~=nil then 
                    if gangPermission>=3 then 
                        if YesNoConfirm()then 
                            TriggerServerEvent("CXRP:kickMemberFromGang",gangID,selectedMember)
                        end 
                    else 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if s~=nil then 
                    if gangPermission>=2 then 
                        TriggerServerEvent("CXRP:InviteUserToGang",gangID,s)
                    else 
    ...
    if showLogsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,161,0,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"Aqua gang - logs",255,255,255,255,7,0)
    ...
    if showSettingsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,161,0,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"Aqua gang - settings",255,255,255,255,7,0)
        ...
        if CursorInArea(0.3187,0.3937,0.4712,0.5462)then 
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                PlaySound(-1,"SELECT","HUD_FRONTEND_DEFAULT_SOUNDSET",0,0,1)
                if YesNoConfirm()then 
                    TriggerServerEvent("CXRP:memberLeaveGang",gangID)
                    PlayerIsInGang=false
                    showGangUI=false
                    showNoGangUI=true
                    showSettingsGangUI=false
            ...
            if IsControlJustPressed(1,329)or IsDisabledControlJustPressed(1,329)then 
                ...
                if gangPermission>=4 then 
                    if YesNoConfirm()==true and gangID~=nil then 
                        TriggerServerEvent("CXRP:DeleteGang",gangID)
                    end 
                else 
    ...
    if showTurfsGangUI then 
        DrawRect(0.501,0.525,0.421,0.387,0,0,0,150)
        DrawRect(0.501,0.308,0.421,0.047,161,0,0,248)
        DrawAdvancedText(0.591,0.312,0.005,0.0028,0.48,"Aqua gang - Turfs",255,255,255,255,7,0)
    ...
    if showGangUI then 
        ...
        DrawAdvancedText(0.591,0.399,0.005,0.0028,0.51,"Aqua Gangs",255,255,255,255,7,0)
...
RegisterNetEvent("CXRP:Notify")
AddEventHandler("CXRP:Notify",function(u)
    Notify(u)
end)
