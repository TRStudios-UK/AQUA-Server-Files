  ...
  while true do 
    if IsDisabledControlJustPressed(0,38) then
      if playerCanRespawn and in_coma and secondsTilBleedout < 2 then
        TriggerServerEvent("CXRP:PoliceCheck")
        TriggerServerEvent("CXRP:RebelCheck")
        TriggerServerEvent("CXRP:VIPCheck")
        TriggerServerEvent("CXRP:getHouses")
        tvRP.respawnPlayer()
        DoScreenFadeIn(900)
        TriggerEvent("CXRP:StartRespawnCam")
        TriggerEvent("CXRP:OpenRespawnMenu")
      end
      Wait(1000)
    end
    Wait(0)
...
RegisterNetEvent("CXRP:5Seconds")
AddEventHandler("CXRP:5Seconds", function()
    DeathAnim = 5
    while DeathAnim <= 5 and DeathAnim >= 0 do
        Wait(1000)
        DeathAnim = DeathAnim - 1
...
RegisterNetEvent("CXRP:FixClient")
AddEventHandler("CXRP:FixClient", function()
