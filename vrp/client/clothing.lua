...
RMenu.Add('vRPClothing', 'main', RageUI.CreateMenu("", "~b~Aqua Clothing Menu",1300, 100, "banners", "clothes"))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('vRPClothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = false, instructionalButton = true}, function()
            RageUI.ButtonWithStyle("Change Clothing", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("vRPClothing", "clothingsubmenu"))
            RageUI.ButtonWithStyle("Change Gender", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("vRPClothing", "changegendersubmenu"))
            RageUI.ButtonWithStyle("Change Ped", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("vRPClothing", "changepedmenu"))
            --RageUI.ButtonWithStyle("Wardrobe", nil, {}, true, function(Hovered, Active, Selected) end, RMenu:Get("vRPClothing", "wardrobesub"))
        end)
    end
                    ...
                    for k, v in pairs(wardrobe) do
                        if k == currentOutfit then
                            ...
                            SetTimeout(50, function()
                                ...
                                TriggerServerEvent('CXRP:changeHairStyle')
                            end)
