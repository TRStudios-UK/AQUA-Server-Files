...
--     if vrp.hasPermission(userid, "admin.tickets")
     --else if
--     while true do
...
-- 			TriggerServerEvent("CX:Type2", theWeapon)
-- 			end
-- 		end
-- 		end
-- 	end)
