...
cfgweapons = module("CXWeapons", "cfg/cfg_weaponNames")
local user_id = 0
tvRP = {}
allowedWeapons = {}
...
Citizen.CreateThread(function()
    while true do
        local ay = {}
        ay.playerPed = GetPlayerPed()
        ay.playerCoords = tvRP.getPlayerCoords()
        ay.playerId = PlayerId()
...
AddEventHandler("playerSpawned",function()
  TriggerEvent("CXRP:UnFreezeRespawn")
end)
