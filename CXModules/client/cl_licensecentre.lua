...
RMenu.Add("CXRP:LicenseStore", "main", RageUI.CreateMenu("", "~b~License Store", 1350, 50,"banners","licenses"))
RMenu.Add("CXRP:LicenseStore", "sub", RageUI.CreateSubMenu(RMenu:Get("CXRP:LicenseStore", "main"), "", "~b~License Store", 1350, 50))
RMenu.Add("CXRP:LicenseStore", "illegal", RageUI.CreateSubMenu(RMenu:Get("CXRP:LicenseStore", "main"), "", "~b~License Store", 1350, 50))
RMenu.Add("CXRP:LicenseStore", "confirm", RageUI.CreateSubMenu(RMenu:Get("CXRP:LicenseStore", "sub"), "", "~b~Confirm License Purchase", 1350, 50))
RMenu.Add("CXRP:LicenseStore", "illegalconfirm", RageUI.CreateSubMenu(RMenu:Get("CXRP:LicenseStore", "illegal"), "", "~b~Confirm License Purchase", 1350, 50))
RMenu.Add("CXRP:LicenseStore", "sub", RageUI.CreateSubMenu(RMenu:Get("CXRP:LicenseStore", "main"), "", "~b~License Store", 1350, 50))
RMenu.Add("CXRP:LicenseStore", "refund", RageUI.CreateSubMenu(RMenu:Get("CXRP:LicenseStore", "main"), "", "~b~Refund License ", 1350, 50))
RMenu.Add("CXRP:LicenseStore", "confirmrefund", RageUI.CreateSubMenu(RMenu:Get("CXRP:LicenseStore", "refund"), "", "~b~Confirm Refund License Purchase", 1350, 50))
RageUI.CreateWhile(1.0, RMenu:Get("CXRP:LicenseStore", "main"), nil, function()
    RageUI.IsVisible(RMenu:Get("CXRP:LicenseStore", "main"), true, false, true, function()

        RageUI.ButtonWithStyle("~g~Grinding Licenses", nil, {RightLabel = ">>>"}, true, function(Hovered, Active, Selected)
            if Selected then
                currentType = "grinding"
            end
        end, RMenu:Get("CXRP:LicenseStore", "sub", true))

        RageUI.ButtonWithStyle("~r~Illegal Licenses", nil, {RightLabel = ">>>"}, true, function(Hovered, Active, Selected)
            if Selected then
                currentType = "other"
            end
        end, RMenu:Get("CXRP:LicenseStore", "illegal", true))
        
        RageUI.ButtonWithStyle("Refund Licenses", nil, {RightLabel = ">>>"}, true, function(Hovered, Active, Selected)
            if Selected then
            TriggerServerEvent("CXRP:RequestLicensescenter")
            end
        end, RMenu:Get("CXRP:LicenseStore", "refund", true))
    end, function() 
    end)

    RageUI.IsVisible(RMenu:Get("CXRP:LicenseStore", "sub"), true, false, true, function()
            ...
            if v.type == currentType then
                RageUI.ButtonWithStyle(v.name, nil, {RightLabel = "~g~£"..getMoneyStringFormatted(v.price)}, true, function(Hovered, Active, Selected)
                    if Selected then
                        ...
                        RMenu:Get("CXRP:LicenseStore", "confirm"):SetSubtitle("~b~Purchase "..v.name.."?")
                    end
                end, RMenu:Get("CXRP:LicenseStore", "confirm", true))
            end
        end
    ...
    RageUI.IsVisible(RMenu:Get("CXRP:LicenseStore", "illegal"), true, false, true, function()
        ...
        for k, v in pairs(cfg.illegal) do
            if v.type == currentType then
                ...
                end, RMenu:Get("CXRP:LicenseStore", "illegalconfirm", true))
            end
        end
    ...
    RageUI.IsVisible(RMenu:Get("CXRP:LicenseStore", "confirm"), true, false, true, function()
        ...
        RageUI.ButtonWithStyle("~g~Confirm Purchase", nil, {RightLabel = "~g~£"..getMoneyStringFormatted(currentLicensePrice)}, true, function(Hovered, Active, Selected)
            if Selected then
                TriggerServerEvent("CXRP:BuyLicense", currentLicense)
            end
        end, RMenu:Get("CXRP:LicenseStore", "main", true))
    ...
    RageUI.IsVisible(RMenu:Get("CXRP:LicenseStore", "illegalconfirm"), true, false, true, function()

        RageUI.Separator("You are buying "..currentLicense.." for ~g~£"..getMoneyStringFormatted(currentLicensePrice))
        RageUI.Separator("")
        RageUI.ButtonWithStyle("~g~Confirm Purchase", nil, {RightLabel = "~g~£"..getMoneyStringFormatted(currentLicensePrice)}, true, function(Hovered, Active, Selected)
            if Selected then
                TriggerServerEvent("CXRP:BuyIllegalLicense", currentLicense)
            end
        end, RMenu:Get("CXRP:LicenseStore", "main", true))
    ...
    while true do
        ...
        if isInArea(cfg.licenseShopLocation, 1.0) and inMenu == false then
            ...
            if IsControlJustPressed(0, 51) then 
                inMenu = true
                RageUI.Visible(RMenu:Get("CXRP:LicenseStore", "main"), true)
            end
        end
...
RageUI.CreateWhile(1.0, RMenu:Get("CXRP:LicenseStore", "refund"), nil, function()
RageUI.IsVisible(RMenu:Get("CXRP:LicenseStore", "refund"), true, false, true, function()
...
for k, v in pairs(cfg.refundlicenese) do
        RageUI.ButtonWithStyle(v.name, nil, {RightLabel = "~g~£"..getMoneyStringFormatted(v.refund)}, true, function(Hovered, Active, Selected)
            if Selected then
                ...
                RMenu:Get("CXRP:LicenseStore", "confirmrefund"):SetSubtitle("~b~Refund "..v.name.."?")
            end
        end, RMenu:Get("CXRP:LicenseStore", "confirmrefund", true))
    end
end)
RageUI.IsVisible(RMenu:Get("CXRP:LicenseStore", "confirmrefund"), true, false, true, function()
    ...
    RageUI.Separator("You will receive ~g~£"..getMoneyStringFormatted(currentLicenserefund).. "~w~ for refunding "..currentLicense)
                ...
                RageUI.ButtonWithStyle("~g~Confirm Refund", nil, {RightLabel = "~g~£"..getMoneyStringFormatted(currentLicensePrice)}, true, function(Hovered, Active, Selected)
                    if Selected then
                        TriggerServerEvent("CXRP:RemoveLicensecenter", currentLicense)
                    end
                end, RMenu:Get("CXRP:LicenseStore", "refund", true))
                RageUI.ButtonWithStyle("~r~Cancel", nil, {}, true, function(Hovered, Active, Selected)
                end, RMenu:Get("CXRP:LicenseStore", "refund", true))
