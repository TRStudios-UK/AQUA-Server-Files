...
RegisterNetEvent("CXRP:PolicePerms")
AddEventHandler("CXRP:PolicePerms",function(pd)
    hasPD = pd
end)
RegisterNetEvent("CXRP:RebelPerms")
AddEventHandler("CXRP:RebelPerms",function(rebel)
    hasRebel = rebel
end)
RegisterNetEvent("CXRP:VIPPerms")
AddEventHandler("CXRP:VIPPerms",function(vip)
    hasVIP = vip
end)

RMenu.Add('RespawnMenu', 'main', RageUI.CreateMenu("", "Aqua Respawn Menu", GetRageUIMenuWidth(),GetRageUIMenuHeight(), "banners", "respawn"))
...
RegisterNetEvent("CXRP:StartRespawnCam")
AddEventHandler("CXRP:StartRespawnCam",function()
    inRedZone = false
    inCam = true
    inMenu = true
    DoScreenFadeIn(500)
...
RegisterNetEvent("CXRP:HousingTable")
AddEventHandler("CXRP:HousingTable",function(houses)
    housetable = houses
end)