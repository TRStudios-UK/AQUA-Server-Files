        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              CXRPcfgdrugsServer.CanProcessWeed({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then

          


                  CXRPcfgdrugsServer.ProcessWeed()
...
function sellingWeedUnits()
    CXRPcfgdrugsServer.SellWeed({tonumber(1)})
    return false
end
