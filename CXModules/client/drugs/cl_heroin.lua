          ...
          while InRangeGather do
            ...
            if IsControlJustReleased(0, 51)  then
              if not pedinveh then
                ...
                CXRPcfgdrugsServer.HeroinGather ()
                Action = false
              else
        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              CXRPcfgdrugsServer.CanProcessHeroin({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  CXRPcfgdrugsServer.ProcessHeroin()
...
function sellingHeroinUnits()
    CXRPcfgdrugsServer.SellHeroin({tonumber(1)})
    return false
end
