        ...
        Citizen.CreateThread(function()
          while InRangeProcess do
            ...
            if IsControlJustReleased(0, 51)  then
              ...
              exports.rprogress:Start("", 5000)
              CXRPcfgdrugsServer.IronCanProcess({}, function(canProcess, ketAmount)
                if canProcess and ketAmount then
                  ...
                  CXRPcfgdrugsServer.IronDoneProcessing()
...
function sellingIronUnits()
     CXRPcfgdrugsServer.SellIronJob({tonumber(1)})
    return false
end
