local cfg = module("CXVehicles", "cfg/cfg_speedcap")
...
metpd = {x = 446.03131103516, y = -984.20489501953, z = 30.689321517944}
...
local blips = {
	...
	{title="Safezone", colour=2, id=1, pos=vector3(446.03131103516,-984.20489501953,30.689321517944),dist=35,nonRP=false,setBit=false}, -- MissionRowPD
}
