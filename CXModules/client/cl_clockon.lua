clockon = {
    {group = "Special Constable Clocked"},
    {group = "Commissioner Clocked"},
    {group = "Deputy Commissioner Clocked"},
    {group = "Deputy Assistant Commissioner Clocked"},
    {group = "Commander Clocked"},
    {group = "Chief Superintendent Clocked"},
    {group = "Superintendent Clocked"},
    {group = "ChiefInspector Clocked"},
    {group = "Inspector Clocked"},
    {group = "Sergeant Clocked"},
    {group = "Senior Constable Clocked"},
    {group = "Police Constable Clocked"},
    {group = "PCSO Clocked"},
}
    ...
    RageUI.IsVisible(RMenu:Get('PDClockOn', 'main'), true, false, true, function()
        for i , p in pairs(clockon) do 
            RageUI.ButtonWithStyle(p.group, nil, { RightLabel = "→→→" }, true, function(Hovered, Active, Selected)
                if Selected then
                    TriggerServerEvent('CXRP:Clockon', p.group)
                    TriggerEvent('CXRP:policeRemove')
                    TriggerServerEvent("CXRP:PoliceCheckRadial")
                end
            end)
        end
...
RegisterNetEvent('CXRP:policeRemove')
AddEventHandler('CXRP:policeRemove', function()
    local source = source
