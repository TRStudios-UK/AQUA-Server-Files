...
dealership.super = {
    {spawncode = "lp770", vehname = "BETA Car!", price = 0 , desciption = "BETA ONLY!"},
}
dealership.suv = {
    {spawncode = "xgcp", vehname = "Mercedes-Benz G63", price = 0 , desciption = "Vehicle Weight: (75kg)"},
    {spawncode = "rrs08", vehname = "Range Rover Supercharged",  price = 0, desciption = "Vehicle Weight: (75kg)"},
    {spawncode = "cayenneturbo", vehname = "Cayenne Turbo", price = 0, desciption = "Vehicle Weight: (75kg)"},
}
dealership.offroad = {
    {spawncode = "03ramk", vehname = "2003 ramk", price = 0 , desciption = "Vehicle Weight: (100kg)"},
    {spawncode = "issio", vehname = "Weeny issio",  price = 0, desciption = "Vehicle Weight: (100kg)"},
}
dealership.GRINDING = {
    {spawncode = "dongfeng140", vehname = "Dongfeng 140 Truck", price = 0 , desciption = "Vehicle Weight: (100kg)"},
