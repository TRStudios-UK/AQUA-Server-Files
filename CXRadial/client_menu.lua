...
Citizen.CreateThread(function()
    ...
    TriggerServerEvent("CXRP:NHSCheckRadial")
end)
...
function Crosshair(enable)
    TriggerEvent("CXRP:PutCrossHairOnScreen", enable)
    Display = enable;
end
...
RegisterNetEvent("CXRP:CleanCar")
AddEventHandler("CXRP:CleanCar",function()
